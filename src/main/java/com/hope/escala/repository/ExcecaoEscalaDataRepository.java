...
public interface ExcecaoEscalaDataRepository extends JpaRepository<ExcecaoEscalaData, Long> {
    ...
    Optional<ExcecaoEscalaData> findByDepartamentoIdAndDataExcecaoAndInstrumentoId(
            Long departamentoId, LocalDate dataExcecao, Long instrumentoId
    );

    List<ExcecaoEscalaData> findByDepartamentoIdAndDataExcecaoBetween(
            Long departamentoId, LocalDate inicio, LocalDate fim
    );
}
