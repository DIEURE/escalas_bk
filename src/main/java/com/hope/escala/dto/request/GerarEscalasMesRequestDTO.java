...
public class GerarEscalasMesRequestDTO {
	...
	public GerarEscalasMesRequestDTO(Long departamentoId, TipoEscala tipoEscala, LocalTime horarioManha,
			LocalTime horarioNoite, String nomeCultoManha, String nomeCultoNoite, Boolean gerarDomingos,
